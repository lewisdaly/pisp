...
![Pre-linking](../out/linking/0-pre-linking/PISP%20Linking%20%20Pre-linking.svg)
...
![Discovery](../out/linking/1-discovery/PISP%20Linking%20%20Discovery.svg)
...
![Request consent](../out/linking/2-request-consent-web/PISP%20Linking%20%20Request%20consent%20(Web).svg)
...
![Request consent](../out/linking/2-request-consent-otp/PISP%20Linking%20%20Request%20consent%20(OTP).svg)
...
![Authentication (Web)](../out/linking/3-authentication-web/PISP%20Linking%20%20Authentication%20(Web).svg)
...
![Authentication (OTP)](../out/linking/3-authentication-otp/PISP%20Linking%20%20Authentication%20(OTP).svg)
...
![Grant consent](../out/linking/4-grant-consent/PISP%20Linking%20%20Grant%20consent.svg)
...
![Credential registration: Challenge](../out/linking/5a-credential-registration/PISP%20Linking%20%20Credential%20registration%20(challenge).svg)
...
![Credential registration: Register](../out/linking/5b-credential-registration/PISP%20Linking%20%20Credential%20registration%20(verification).svg)
...
![Credential registration: Register](../out/linking/unlinking/PISP%20Linking%20%20Unlinking.svg)
...
![Credential registration: Register](../out/linking/3-authentication-third-party-fido/PISP%20Linking%20%20Authentication%20(Third-party%20FIDO%20registration).svg)
