...
![Pre-linking](../out/linking/0-pre-linking/PISP_Linking__Pre-linking.svg)
...
![Discovery](../out/linking/1-discovery/PISP_Linking__Discovery.svg)
...
![Request consent](../out/linking/2-request-consent-web/PISP_Linking__Request_consent_(Web).svg)
...
![Request consent](../out/linking/2-request-consent-otp/PISP_Linking__Request_consent_(OTP).svg)
...
![Authentication (Web)](../out/linking/3-authentication-web/PISP_Linking__Authentication_(Web).svg)
...
![Authentication (OTP)](../out/linking/3-authentication-otp/PISP_Linking__Authentication_(OTP).svg)
...
![Grant consent](../out/linking/4-grant-consent/PISP_Linking__Grant_consent.svg)
...
![Credential registration: Challenge](../out/linking/5a-credential-registration/PISP_Linking__Credential_registration_(challenge).svg)
...
![Credential registration: Register](../out/linking/5b-credential-registration/PISP_Linking__Credential_registration_(verification).svg)
...
![Credential registration: Register](../out/linking/unlinking/PISP_Linking__Unlinking.svg)
...
![Credential registration: Register](../out/linking/3-authentication-third-party-fido/PISP_Linking__Authentication_(Third-party_FIDO_registration).svg)
